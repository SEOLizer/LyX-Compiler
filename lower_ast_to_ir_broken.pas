  ...
  case expr.Kind of
    ...
    nkSIMDIndexAccess:
      begin
        ...
        // Lower the vector (should be TAstSIMDNew or SIMD expression)
        ...
        // For now, emit an error - full implementation would:
        // 1. Check bounds
        // 2. Calculate element address: vec + index * elementSize
        // 3. Load the element
        FDiag.Error('SIMD index access not yet fully implemented in backend', expr.Span);
        Result := -1;
      end;
