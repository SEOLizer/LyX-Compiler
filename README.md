...
| **v0.8.8C** | ✅ **`std/pdf` WP-PDF-20**: `PdfSetPageRotation` — `/Rotate`-Eintrag im Page-Dict (0/90/180/270°) · ✅ **`std/pdf` WP-PDF-23**: Form XObjects — `PdfBeginXObject`/`PdfEndXObject`/`PdfDrawXObject`/`PdfDrawXObjectScaled` (reusable graphic blocks, content einmal definiert, N-fach platziert) |
