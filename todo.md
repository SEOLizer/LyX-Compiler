...
**Implementiert ✅:** exit, PrintStr, Println, PrintInt, open, read, write, close, lseek, unlink, mkdir, mmap, munmap, ioctl, getpid, StrLen, StrCharAt, StrSetChar, StrNew (stub), StrFree (stub), StrFromInt (stub)
